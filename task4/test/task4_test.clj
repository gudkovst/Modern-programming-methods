...
(test/deftest task4.infix-form-test
  (test/testing "Testing task4.infix-form"
    (test/is (let [e (infix-form (/ (1 + ::d) > ::x))] (and (ngt? e) (implication? (args e)))))
    (test/is (= (dnf (infix-form (::x * (::y * (::y * 1))))) (dnf (infix-form (::x * ::y)))))
    (test/is (= 4 (count (args (dnf (infix-form (::x * (::y * ((::a + (::b * ::c)) * (::a + ::d))))))))))
    (test/is (= 4 (count (args (dnf (infix-form (::x > (::y > (::q + ::w)))))))))
    ))
